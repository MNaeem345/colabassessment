...
function Projects(){
    ...
    return(
        <section id="projects" className='all-projects'>
            ...
            <div className="cards">
                <div className="project1 col-md-4">
                    ...
                    </p><a href="https://github.com/MNaeem345/CryptoView" target="_blank"><button className="github-button" ><i class= "fa-brands fa-github" swapOpacity></i></button></a>
                </div>
            
            
                <div className="project2 col-md-4">
                ...
                <div className="project3 col-md-4">
                ...
                <div className="project4 col-md-4">
